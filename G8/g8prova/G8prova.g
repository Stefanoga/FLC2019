...
line 	:	'LINE:' 'XSTART' l1=FLOAT {float xstart=$l1.text;} 'YSTART' l2=FLOAT {float ystart=$l2.text;} 'XEND' l3=FLOAT {float xend=$l3.text;} 'YEND' l4=FLOAT {float yend=$l4.text;} ('COLOR' l5=RGB {String color=$l5.text;})? ('WIDTH' l6=FLOAT {float width=$l6.text;})? 
...
rectangle 	:	'RECT:' 'XSTART' r1=FLOAT {float xstart=$r1.text;} 'YSTART' r2=FLOAT {float ystart=$r2.text;} 'XEND' r3=FLOAT {float xend=$r3.text;} 'YEND' r4=FLOAT {float yend=$r4.text;} ('COLOR' r5=RGB {String color=$r5.text;})? ('WIDTH' r6=FLOAT {float width=$r6.text;})? ('COLORBODY' r7=RGB {String colorbody=$r7.text;})?
			{float heigth=r4-r2;
			 float breadth=r3-r1;
			 System.out.println("context.beginPath();");
			 System.out.println("context.lineWidth = " + width + ";");
